...
flowchart TD
    ...
    B --> C[Preenche campo Origem]
    C --> D[Preenche campo Destino]
    D --> E[Seleciona tipo de veículo no dropdown]
    ...
    D --> E[Clica em Comparar]
    E --> F[Sistema exibe tabela lado a lado]
    ...
    D --> E[Informa consumo do veículo]
    E --> F[Clica em Simular]
    ...
    D --> E[Usa linhas para evolução temporal]
    ...
    D --> E[Mostra mensagem de confirmação]
    E --> F[Usuário navega para Salvos]
    ...
    D --> E[Adiciona múltiplas rotas]
    E --> F[Sistema consolida custos de todos veículos]
    ...
    D --> E[Sistema processa dados históricos]
    E --> F[Exibe dashboard com múltiplos gráficos]
